...
public class Main {
  public static void main(String[] args){
        ...
        StudentCourse[] bachelor = new StudentCourse[]{studentCourse1, studentCourse2, studentCourse3, studentCourse4, studentCourse5};
        StudentCourse[] master = new StudentCourse[]{studentCourse6, studentCourse7, studentCourse8, studentCourse9, studentCourse10, studentCourse11};
        student1.degrees[0].setDegreeTitle("Bachelor of Science");
        student1.degrees[1].setDegreeTitle("Master of Science");
        student1.degrees[0].setTitleOfThesis("Bachelor thesis title");
        student1.degrees[1].setTitleOfThesis("Masters thesis title");
        student1.degrees[0].addStudentCourses(bachelor);
        student1.degrees[1].addStudentCourses(master);
